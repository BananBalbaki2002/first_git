...
class MAddProfile extends StatefulWidget {
  String? _imgPath;

  @override
  _MAddProfileState createState() => _MAddProfileState();
}

class _MAddProfileState extends State<MAddProfile> {
        ...
        FloatingActionButton(
            ...
            onPressed: () async {
              ...
              if ( contr.phone == null)
                ...
                await contr.onClickMAddProfile(widget._imgPath);
