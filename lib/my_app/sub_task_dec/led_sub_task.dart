...
import 'package:tasko/my_app/sub_task_dec/show_subtask_controller.dart';
...
class LeaderSubTask extends StatelessWidget {
  ...
  LeaderSubTask({Key? key, this.id}) : super(key: key);
  @override
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text('edit',style: TextStyle(fontWeight: FontWeight.bold,fontSize: size.width*0.05,color: appCo),))
